# stimulus_response_scalar_parameters_basic (ndi.document class)

## Class definition

**Class name**: [ndi_document_stimulus_stimulus_response_scalar_parameters](stimulus_response_scalar_parameters_basic.md)<br>
**Short name**: [stimulus_response_scalar_parameters_basic](stimulus_response_scalar_parameters_basic.md)<br>
**Superclasses**: [ndi_document](../ndi_document.md), [stimulus_response_scalar_parameters](../stimulus/stimulus_response_scalar_parameters.md)
...
## [stimulus_response_scalar_parameters_basic](stimulus_response_scalar_parameters_basic.md) fields
...
## [stimulus_response_scalar_parameters](../stimulus/stimulus_response_scalar_parameters.md) fields

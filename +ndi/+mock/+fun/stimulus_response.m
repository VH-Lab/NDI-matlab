...
parameters.input_parameters.selection = struct('property','contrast','operation','hasfield','value','varies'); %what if changing the property here fixes contrast_tuning?

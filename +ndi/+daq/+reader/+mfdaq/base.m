...
%
% The ndi.daq.reader.mfdaq.base object class.
%
...
% 
%
% See also: ndi.daq.reader.mfdaq.base/ndi.daq.reader.mfdaq.base
%

classdef base < ndi.daq.reader.base
	...
	methods
		function obj = base(varargin)
			% ndi.daq.reader.mfdaq.base - Create a new multifunction DAQ object
			%
			%  D = ndi.daq.reader.mfdaq.base()
			%
			%  Creates a new ndi.daq.reader.mfdaq.base object.
			%  This is an abstract class that is overridden by specific devices.
				obj = obj@ndi.daq.reader.base(varargin{:});
		end; % ndi.daq.reader.mfdaq.base
		...
		% functions that override ndi.epoch.epochset
			...
			% 
			% For the generic ndi.daq.reader.mfdaq.base, this returns a single clock
			% type 'dev_local'time';
			%

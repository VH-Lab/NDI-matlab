    ...
    methods
        ...
        function addDoc(obj, docs)
            for i=1:numel(docs)
                ...
                obj.fullTable(end+1,:) = {d.name d.id d.type d.datestamp char(split(jsonDetails,newline))};
            end

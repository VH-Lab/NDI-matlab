...
%% Step 4. DOCUMENTS. Process tables (experimentInfo, data, encounter)
...
experimentVariables = {'expNum',...
    'growthBacteriaSpecies','growthBacteriaStrain',...
    'OD600Real','CFU',...
...
plateVariables = {'experiment_id','plateNum','exclude',...
    ...
    'bacteriaSpecies','bacteria',...
    'OD600','timeSeed','timeColdRoom','timeRoomTemp',...
    'lawnVolume','lawnSpacing',...
    'temp','humidity'};

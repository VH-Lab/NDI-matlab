...
experimentVariables = {'expNum','bacteria','OD600Real_bacteria','CFU_bacteria'};
plateVariables = {'experiment_id','plateNum_bacteria','OD600_bacteria','lawnVolume_bacteria',...
    'peptoneFlag_bacteria','timePoured','timePouredColdRoom',...
    'timeSeed_bacteria','timeColdRoom_bacteria','timeRoomTemp_bacteria'};

...
ndi_globals.databasehierarchy = struct( ...
	...
	'code',         'db=ndi.database.implementations.database.matlabdumbjsondb(''FILEPATH'', ''SESSION_REFERENCE'', ''load'',''FILENAME'');',  ...
	'newcode',      'db=ndi.database.implementations.database.matlabdumbjsondb(''FILEPATH'', ''SESSION_REFERENCE'', ''new'',''FILEPATHndi.dumbjsondb.json'');' ...
);

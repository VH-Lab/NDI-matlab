...
if (numel(metadata_editor_docs) > 0)
    ...
    datasetInformation = extract_from_openminds(D);
end
...
function datasetInformation = read_metadata_editor(metadata_editor_docs)
    ...
    datasetInformation = ndi.database.metadata_app.fun.convertDocumentToDatasetInfo(document);
end

function datasetInformation = extract_from_openminds(D)
    datasetInformation = {};
    author_doc = {};

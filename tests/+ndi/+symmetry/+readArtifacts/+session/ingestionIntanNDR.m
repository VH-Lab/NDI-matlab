classdef ingestionIntanNDR < matlab.unittest.TestCase
    ...
    methods (Test)
        function testIngestionIntanNDRArtifacts(testCase, SourceType)
            % Determine the artifact directory expected from either MATLAB or Python
            artifactDir = fullfile(tempdir(), 'NDI', 'symmetryTest', SourceType, 'session', 'ingestionIntanNDR', 'testIngestionIntanNDRArtifacts');

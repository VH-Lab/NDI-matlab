classdef ingestionIntanNDR < ndi.unittest.session.buildSessionNDRIntan
    ...
    methods (Test)
        function testIngestionIntanNDRArtifacts(testCase)
            % Determine the artifact directory
            artifactDir = fullfile(tempdir(), 'NDI', 'symmetryTest', 'matlabArtifacts', 'session', 'ingestionIntanNDR', 'testIngestionIntanNDRArtifacts');

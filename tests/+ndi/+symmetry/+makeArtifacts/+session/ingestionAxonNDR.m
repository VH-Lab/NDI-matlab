classdef ingestionAxonNDR < ndi.unittest.session.buildSessionNDRAxon
    ...
    methods (Test)
        function testIngestionAxonNDRArtifacts(testCase)
            % Determine the artifact directory
            artifactDir = fullfile(tempdir(), 'NDI', 'symmetryTest', 'matlabArtifacts', 'session', 'ingestionAxonNDR', 'testIngestionAxonNDRArtifacts');

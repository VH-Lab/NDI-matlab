classdef blankSessionVhlab < matlab.unittest.TestCase
    ...
    methods (TestMethodSetup)
        function setupBlankSession(testCase)
            testCase.SessionPath = fullfile(tempdir(), 'NDI', 'test_blankSessionVhlab');
    ...
    methods (Test)
        function testBlankSessionVhlab(testCase)
            artifactDir = fullfile(tempdir(), 'NDI', 'symmetryTest', 'matlabArtifacts', 'session', 'blankSessionVhlab', 'testBlankSessionVhlab');

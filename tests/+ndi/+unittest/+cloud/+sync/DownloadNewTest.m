classdef DownloadNewTest < ndi.unittest.cloud.sync.BaseSyncTest
    ...
    methods(Test)
        ...
        function testInitialDownload(testCase)
            ...
            doc = ndi.document('base', 'base.name', 'remote_doc_1');
        ...
        function testIncrementalDownload(testCase)
            ...
            % 1. Initial sync
            doc1 = ndi.document('base', 'base.name', 'remote_doc_1');
            ...
            names = sort(cellfun(@(x) string(x.document_properties.base.name), local_docs, 'UniformOutput', false));

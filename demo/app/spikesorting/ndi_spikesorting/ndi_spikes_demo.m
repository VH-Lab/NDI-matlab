...
dev1 = ndi_daqreader_mfdaq_sg('SpikeGadgets', filenav);
exp.daqreader_add(dev1);
spike_extractor = ndi_app_spikeextractor(exp);
spike_sorter = ndi_app_spikesorter(exp);
spike_extractor.spike_extract_probes('Tetrode7', 'n-trode', 1, 'test', 'ndi_common/example_app_experiments/exp_sg/extraction_parameters.txt')

...
% 
% [DAQNAMES, CHANNEL_TYPES, CHANNELS, EPOCHIDS, SUBJECT] = NDI_GETDAQSFROMPROBE(NDI_PROBE_OBJ)
%
...
% from epoch to epoch.
%
% SUBJECT is a single NDI_DOCUMENT object for the subject.
% 

subject_id = ndi_probe_obj.subject_id;
subject = ndi_probe_obj.session.database_search(ndi_query('ndi_document.id','exact_string',subject_id,''));

function [y, varargout] = nsd_evaluate_fitcurve(fitcurve_doc, varargin)
% NSD_EVALUTE_FITCURVE - evaluate a fitcurve (the standard fitcurve type)
% 
% Y = NSD_EVALUTE_FITCURVE(FITCURVE_DOC, X, ...)
%
...
if numel(fit_parameter_values) ~= numel(fit_parameter_names),
 ...
 % Step 2: Change all variables from 'name' to 'nsd_evaluate_fitcurve_name'

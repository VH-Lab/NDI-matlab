...
%
	...
	methods
		function obj = nsd_iodevice_mfdaq_cedspike2(varargin)
			% NSD_IODEVICE_MFDAQ_CEDSPIKE2 - Create a new NSD_DEVICE_MFDAQ_CEDSPIKE2 object
			%
			%  D = NSD_IODEVICE_MFDAQ_CEDSPIKE2(NAME,THEFILETREE)
			%
			%  Creates a new NSD_IODEVICE_MFDAQ_CEDSPIKE2 object with name NAME and associated
	...
	methods (Static)  % helper functions
		...
		% CEDSPIKE2HEADERTYPE2MFDAQCHANNELTYPE- Convert between Intan headers and the NSD_IODEVICE_MFDAQ channel types 
		%

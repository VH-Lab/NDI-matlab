...
%  This is an abstract class that is overridden by specific devices.
	...
	methods
        ...
        % 
        % Creates an NDI_DAQSYSTEM with NDI_EXPERIMENT EXPERIMENT, NDI_DOCUMENT_DAQSYSTEM DAQSYSTEM_DOC,
		%  and STRING DAQSYSTEM_NAME.
		%  OBJ = NDI_DAQSYSTEM(EXPERIMENT, DAQSYSTEM_DOC, DAQSYSTEM_NAME)

    ...
    methods (Access = private)
        ...
        %   preferences editor.
            ...
            obj.addItem('Parallel', "", 'NumberOfWorkers', ...
                0, 'double', ...
                ['Largest number of workers a parallel loop may use. 0 means ' ...
                 'NDI sets no limit of its own: a pool you opened is used at ' ...
                 'its own size, and a pool opened by NDI takes the MATLAB ' ...
                 'default. Set a small number on a machine with limited ' ...
                 'memory, where one worker per core may be more than it can ' ...
                 'hold.']);
        end

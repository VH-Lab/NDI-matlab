function submit_publish_dataset(dataset_id)
    ...
    %% test submit
    % TODO: Update deprecated function call. Replace ndi.cloud.api.datasets.submit_dataset with ndi.cloud.api.datasets.submitDataset
    % response = ndi.cloud.api.datasets.submit_dataset(dataset_id);

    %% test publish
    % TODO: Update deprecated function call. Replace ndi.cloud.api.datasets.publish_dataset with ndi.cloud.api.datasets.publishDataset
    ...
    %% test unpublish
    % TODO: Update deprecated function call. Replace ndi.cloud.api.datasets.unpublish_dataset with ndi.cloud.api.datasets.unpublishDataset
    ...
    try
        % TODO: Update deprecated function call. Replace ndi.cloud.api.datasets.get_unpublished with ndi.cloud.api.datasets.getUnpublished

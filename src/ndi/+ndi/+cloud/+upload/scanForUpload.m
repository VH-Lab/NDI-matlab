function [doc_json_struct, doc_file_struct, total_size] = scanForUpload(S, d, new, dataset_id)
    %SCANFORUPLOAD - scan documents for files and information needed for upload
    %
    % [DOC_JSON_STRUCT,DOC_FILE_STRUCT] = ndi.cloud.upload.scanForUpload(S, d, new, DATASET_ID)
    %
    % Inputs:

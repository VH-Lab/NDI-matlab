...
%
%   [B, ANSWER, APIRESPONSE, APIURL] = ndi.cloud.api.files.listFilesAll(CLOUDDATASETID, 'limit', L)
%
%   Retrieves a complete list of all file summaries from a dataset by following
%   the keyset cursor across pages. This is the whole-dataset counterpart to
%   ndi.cloud.api.files.listFiles, which returns a single page.
%
%   Inputs:
%       cloudDatasetID  - The ID of the dataset.
%   Name-Value Inputs:
%       limit           - (Optional) Maximum number of results fetched per API
%                         call. Default is 1000.
...
%                         re-checking for updates. Default is 5.

classdef filefind < ndi.time.syncrule
    ...
    methods
        ...
        function [cost,mapping] = apply(ndi_syncrule_filefind_obj, epochnode_a, epochnode_b, daqsystem1)
            ...
            %
            % [COST, MAPPING] = APPLY(NDI_SYNCRULE_FILEFIND_OBJ, EPOCHNODE_A, EPOCHNODE_B, DAQSYSTEM1)
            %

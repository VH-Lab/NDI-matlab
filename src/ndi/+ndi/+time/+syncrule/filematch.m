classdef filematch < ndi.time.syncrule
    ...
    methods
        ...
        function [cost,mapping] = apply(ndi_syncrule_filematch_obj, epochnode_a, epochnode_b, daqsystem1)
            ...
            %
            % [COST, MAPPING] = APPLY(NDI_SYNCRULE_FILEMATCH_OBJ, EPOCHNODE_A, EPOCHNODE_B, DAQSYSTEM1)
            %

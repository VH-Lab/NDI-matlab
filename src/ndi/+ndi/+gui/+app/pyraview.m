...
%   See also: ndi.gui.app.sessionApp, ndi.gui.navigator, ndi.session
    ...
    methods (Access = private)
        function build(obj)
            ...
            uicontrol(fig, 'Style', 'popupmenu', 'String', {'all', 'low', 'high'}, ...
                'Units', 'pixels', 'Position', [10 10 80 20], ...
                'Tag', 'BandMenu', 'Callback', callback, 'Value', 3, ...
                'FontSize', 14); % Order: all (unfiltered), then low/high by frequency; default high

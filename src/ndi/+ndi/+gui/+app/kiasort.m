    ...
    methods (Access = private)
        function build(obj)
            ...
            root = uigridlayout(obj.fig, [6 1], ...
                'RowHeight', {30, 18, '1x', 18, 70, 44}, 'ColumnWidth', {'1x'}, ...
            ...
            % Main KIASORT config checkboxes (field, label, default). These are the
            % boolean options from kiaSort_main_configs; their values are passed to
            % ndi.fun.probe.import.kiasort.run as cfg_overrides.
            defs = { ...
                'useGPU',             'Use GPU',             true; ...
            ...
            cfgGrid = uigridlayout(root, [2 3], ...
                'RowHeight', {'1x','1x'}, 'ColumnWidth', {'1x','1x','1x'}, ...

...
%
% NDI.FUN.PROBE.IMPORT.KIASORT.REMOVEOLD(S, KC_DOC)
%
% Removes a previously imported set of KIASORT neurons from the ndi.session S.
% KC_DOC is a 'kiasort_clusters' ndi.document. This function finds every

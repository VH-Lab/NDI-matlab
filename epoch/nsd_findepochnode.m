function index = nsd_findepochnode(epochnode, epochnodearray)
% NSD_FINDEPOCHNODE - find an occurence of an epochnode in an array of epochnodes
%
% INDEX = NSD_FINDEPOCHNODE(EPOCHNODE, EPOCHNODEARRAY)
%

function t = ndi_document2element(ndi_document_obj, ndi_experiment_obj)
% NDI_DOCUMENT2ELEMENT - create an NDI_ELEMENT object from an NDI_DOCUMENT
%
% T = NDI_DOCUMENT2ELEMENT(NDI_DOCUMENT_OBJ, NDI_EXPERIMENT_OBJ)
%
% Create an NDI_ELEMENT object T from an NDI_DOCUMENT object that has
% a 'element' parameter and is related to an experiment NDI_EXPERIMENT object
% that is provided.
%
